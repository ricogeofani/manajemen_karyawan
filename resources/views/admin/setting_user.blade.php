                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_karyawan" class="form-control">
                                @foreach ($data_karyawan as $karyawan)
                                    <option :selected="{{ $karyawan->id }} == data.id_karyawan" value="{{ $karyawan->id }}">{{ $karyawan->nama }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="level" class="form-control">
                                ...
                                <option :selected="data.level == 'staff' "value="staff">Staff</option>
                                <option :selected="data.level == 'hrd' "value="hrd">Hrd</option>
                            </select>
                        </div>
                    </div>
...
@push('js')
    ...
    <script type="text/javascript">
        var actionUrl = '{{ url('api/user') }}';
        var columns = [
            {data: 'karyawan.nama', class: 'text-center', orderable: true},
